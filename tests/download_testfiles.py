...
links_yaml_quicktest_files = (
    "../directlfq/configs/download_links_for_testfiles_quicktest.yaml"
)
...
if __name__ == "__main__":
    ...
    testfieldownloader = directlfq.testfile_handling.TestFolderDownloader(
        test_folder=test_folder, links_yaml=links_yaml
    )

...
import logging
import warnings
import alphabase.quantification.quant_reader.quant_reader_manager as ab_quant_reader_manager
...
,compile_normalized_ion_table = True):
    ...
    input_df = ab_quant_reader_manager.import_data(input_file=input_file, input_type_to_use=input_type_to_use, 
                                                   filter_dict=filter_dict, use_alphaquant_format=True, protein_id= "protein", quant_id="ion")

# AUTOGENERATED! DO NOT EDIT! File to edit: 06_visualizations.ipynb (unless otherwise specified).

__all__ = ['AlphaPeptColorMap', 'CmapRegistrator', 'IonTraceCompararisonPlotter', 'IonTraceVisualizer',
           'MultiOrganismMultiMethodBoxPlot']
...
class IonTraceVisualizer():
    ...
    def _plot_ion_traces(self):
        colors = ["#c0c0c0", "#cdcdcd"]# Set your custom color palette

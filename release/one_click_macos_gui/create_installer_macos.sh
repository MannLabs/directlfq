...
pip install "../../dist/directlfq-0.2.6-py3-none-any.whl[stable, gui]"
...
pkgbuild --root dist/directlfq --identifier de.mpg.biochem.directlfq.app --version 0.2.6 --install-location /Applications/directlfq.app --scripts scripts directlfq.pkg

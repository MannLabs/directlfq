...
pkgbuild --root dist/directlfq --identifier de.mpg.biochem.directlfq.app --version 0.2.4 --install-location /Applications/directlfq.app --scripts scripts directlfq.pkg
